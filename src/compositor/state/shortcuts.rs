...
impl CompositorState {
    ...
    pub(in crate::compositor) fn astrea_shortcut_registration_allowed(
        ...
        astrea_shell_pid_is_authorized(pid, &self.astrea_shell_client_pids)
    }
...
pub(crate) fn astrea_shell_pid_is_authorized(pid: u32, authorized_pids: &HashSet<u32>) -> bool {
    astrea_shell_pid_is_authorized_with_lookup(pid, authorized_pids, proc_parent_pid)
}
