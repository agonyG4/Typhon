    ...
    fn request(
        ...
        match request {
            ...
            zwp_relative_pointer_manager_v1::Request::GetRelativePointer { id, .. } => {
                ...
                state.add_relative_pointer_resource(pointer);
            }
            _ => {}
        }
    }
...
impl Dispatch<zwp_relative_pointer_v1::ZwpRelativePointerV1, ()> for CompositorState {
    fn request(
        state: &mut Self,
        _client: &Client,
...
impl Dispatch<zwp_locked_pointer_v1::ZwpLockedPointerV1, ()> for CompositorState {
    fn request(
        _state: &mut Self,
        _client: &Client,
...
impl Dispatch<zwp_confined_pointer_v1::ZwpConfinedPointerV1, ()> for CompositorState {
    fn request(
        _state: &mut Self,
        _client: &Client,
