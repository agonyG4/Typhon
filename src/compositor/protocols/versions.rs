...
pub(crate) const WP_CONTENT_TYPE_MANAGER_V1: u32 = 1;
pub(crate) const ZXDG_DECORATION_MANAGER_V1: u32 = 2;
...
pub(crate) const ALL_GLOBALS: &[GlobalAdvertisement] = &[
    ...
    GlobalAdvertisement::new("wp_content_type_manager_v1", WP_CONTENT_TYPE_MANAGER_V1),
