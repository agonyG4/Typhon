use super::*;
    ...
    pub(crate) fn native_seat_lifecycle_requests_suspend_then_resume() {
    ...
    #[test]
    pub(crate) fn native_input_state_handles_normalized_relative_motion() {
    ...
    #[test]
    pub(crate) fn native_input_pointer_motion_can_skip_frame_repaint_with_hardware_cursor() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_forwarded_keyboard_input_skips_frame_repaint_without_local_visual_change() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_forwarded_pointer_button_skips_frame_repaint_without_local_visual_change() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_forwarded_pointer_axis_skips_frame_repaint_without_local_visual_change() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_input_window_interaction_still_repaints_with_hardware_cursor() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_libinput_scroll_axis_value_skips_absent_axis_reader() {
    ...
    #[test]
    pub(crate) fn native_xrgb_copy_preserves_ignored_high_byte_for_fast_row_copy() {
    ...
    #[test]
    pub(crate) fn native_xrgb_copy_damage_updates_only_requested_rectangles() {
    ...
    #[test]
    pub(crate) fn native_xrgb_copy_damage_caps_overlapping_rects_at_full_frame_copy() {
        let frame = [0xff00_0001, 0xff00_0002, 0xff00_0003, 0xff00_0004];
        let mut bytes = [0; 16];
    ...
    #[test]
    pub(crate) fn native_frame_renderer_repairs_surface_bounds_change_with_partial_scene_rebuild() {
    ...
    #[test]
    pub(crate) fn native_frame_renderer_reports_full_scene_rebuild_when_surface_identity_changes() {
        let spotlight = SpotlightModel::default();
        let mut renderer = NativeFrameRenderer::default();
        let initial_surface = test_renderable_surface(7, 0, 0, 4, 4, RenderableSurfaceDamage::Full);
    ...
    #[test]
    pub(crate) fn native_cursor_argb_bytes_places_texture_pixels_in_pitched_buffer() {
    ...
    #[test]
    pub(crate) fn native_input_coalesces_consecutive_relative_motion_events() {
    ...
    #[test]
    pub(crate) fn native_pointer_motion_sample_keeps_relative_delta_when_cursor_clamps_at_edge() {
        let mut input = NativeInputState::new(320, 200);
    ...
    #[test]
    pub(crate) fn native_input_coalescing_preserves_button_boundaries() {
        let events = coalesce_pointer_motion_events(vec![
            NativeHardwareInputEvent::PointerMotion(PointerMotionSample::relative(
                10,
    ...
    #[test]
    pub(crate) fn native_input_coalesces_consecutive_absolute_motion_to_latest_position() {
        let events = coalesce_pointer_motion_events(vec![
    ...
    #[test]
    pub(crate) fn input_event_paths_select_only_real_keyboard_and_mouse_devices() {
    ...
    #[test]
    pub(crate) fn native_repaint_decision_skips_visible_frame_callback_without_damage() {
        assert_eq!(
    ...
    #[test]
    pub(crate) fn native_repaint_decision_paints_non_callback_pending_frame_work() {
        assert_eq!(
            native_repaint_decision(NativeRepaintInputs {
                accepted_clients: false,
                render_generation_changed: false,
    ...
    #[test]
    pub(crate) fn native_repaint_decision_paints_visual_changes_even_with_frame_callback() {
        assert_eq!(
            native_repaint_decision(NativeRepaintInputs {
                accepted_clients: false,
    ...
    #[test]
    pub(crate) fn native_repaint_decision_waits_for_pending_pageflip_before_repaint() {
        assert_eq!(
            native_repaint_decision(NativeRepaintInputs {
                accepted_clients: false,
                render_generation_changed: true,
