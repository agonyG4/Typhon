...
impl NativeRuntime {
    pub(super) fn render_present_and_update_metrics(
        ...
        #[rustfmt::skip] let (pageflip_drain_us, pageflip_completed, pageflip_pending_at_tick) = (cycle.pageflip_drain_us, cycle.pageflip_completed, cycle.pageflip_pending_at_tick);
        ...
        *scheduled_presentation_target = plan_visual_target_for_budget(
        ...
        if matches!(
            ...
            if direct_submitted {
                #[rustfmt::skip] frame_pacing.log("render_complete", vec![frame_id_field(frame_pacing.active), PacingField::u64("render_generation", render_generation), PacingField::u64("gpu_draw_us", 0), PacingField::bool("direct_scanout", true)]);
