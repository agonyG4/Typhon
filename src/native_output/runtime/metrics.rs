...
fn worker_timing_snapshot(snapshot: WorkerTimingSnapshot) -> WorkerTimingPerformanceSnapshot {
    WorkerTimingPerformanceSnapshot {
        ...
        dispatch_tail_guard_us: snapshot.dispatch_tail_guard_ns / 1_000,
        dispatch_deadline_overrun_us: snapshot.dispatch_deadline_overrun_ns / 1_000,
        dispatch_tail_guard_increases: snapshot.dispatch_tail_guard_increases,
        dispatch_tail_guard_decays: snapshot.dispatch_tail_guard_decays,
        dispatch_tail_guard_cap_hits: snapshot.dispatch_tail_guard_cap_hits,
