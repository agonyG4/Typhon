...
pub(crate) struct NativePaintStats {
    ...
    pub(crate) shm_full_resyncs: usize,
...
impl NativePaintStats {
    pub(crate) fn fields(self) -> Vec<NativePerfField> {
        let mut fields = vec![
            ...
            NativePerfField::usize(
                "surface_resource_consumers",
                self.surface_resource_consumers,
            ),
            NativePerfField::usize("surface_resource_deferred", self.surface_resource_deferred),
            NativePerfField::usize("shm_full_resyncs", self.shm_full_resyncs),
