...
pub(crate) struct X11WindowRecord {
    ...
    pub(crate) resolved_properties: u32,
    pub(crate) pending_properties: u32,
    pub(crate) dirty_properties: u32,
    pub(crate) refresh_properties: u32,
...
pub(crate) struct X11PropertySnapshot {
    ...
    pub(crate) supports_sync_request: bool,
...
impl X11WindowRegistry {
    ...
    pub(crate) fn try_ready(
        ...
        let snapshot = X11WindowSnapshot {
            ...
            supports_sync_request: record.properties.supports_sync_request,
