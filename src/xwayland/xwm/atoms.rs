...
impl XwmAtomName {
    ...
    pub(crate) const fn as_bytes(self) -> &'static [u8] {
        match self {
            ...
            Self::Multiple => b"MULTIPLE",
            Self::AtomPair => b"ATOM_PAIR",
            Self::Incr => b"INCR",
            Self::Clipboard => b"CLIPBOARD",
            Self::Targets => b"TARGETS",
            Self::SelectionTargets => b"_ASTREA_SELECTION_TARGETS",
            Self::SelectionData => b"_ASTREA_SELECTION_DATA",
            Self::SelectionProxyTime => b"_ASTREA_SELECTION_PROXY_TIME",
